 ...
 */
public class MyTopTenTracksActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.top_ten_tracks_fragment);
        ...
        if(savedInstanceState == null){
            ...
            String artistId = getIntent().getStringExtra(ArtistSearchFragment.ARTIST_ID);
        ...
        protected void onPostExecute(Tracks artistTopTracks) {
            ...
            try {
                ...
                if (artistTopTracks.tracks.isEmpty()) {
                    Toast.makeText(MyTopTenTracksActivity.this, getResources().getString(R.string.tracks_not_found), Toast.LENGTH_SHORT).show();
                    mAdapter.clear();
                    return;
                }
